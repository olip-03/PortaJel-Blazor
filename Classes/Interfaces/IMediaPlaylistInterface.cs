...
{
    Task<bool> AddAsync(Guid playlistId, BaseMusicItem musicItem, string serverUrl = "", CancellationToken cancellationToken = default);
    Task<bool> AddRangeAsync(Guid playlistId, BaseMusicItem[] musicItems, string serverUrl = "", CancellationToken cancellationToken = default);
